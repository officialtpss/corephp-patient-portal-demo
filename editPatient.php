<?php
    ...
    $municipalities = _get_municipalities($patient['department_id']);
...
<div class="content">
    ...
    <form action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>?patient_id=<?php echo $patient['id'];?>" method="POST" enctype="multipart/form-data" > 
        ...
        <div class="form-group">
            <div class="row">
                ...
                <div class="col">
                    ...
                    <input type="submit" class="btn btn-success btn-block pull-right" name="submit" value="Update">
                </div>
            </div>
        </div>
